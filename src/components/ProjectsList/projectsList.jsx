...
export const ProjectsList = [
    {
        ...
        context: 'L\'entreprise souhaite développer un site Internet qui permette aux usagers de trouver des hébergements et des activités dans la ville de leur choix. Il faut développer l\'interface du site avec du code HTML et CSS',
        objectifs: 'Objectifs :',
    ...
    ,
    {
        ...
        objectifs1: '- Réalisation du site avec Wordpress',
        objectifs2: '- Réalisation de la version Desktop et mobile',
        objectifs3: '- Réalisation d\'un site OnePage avec un effet parallax pour les images de transition au scroll',
        objectifs4: '- Intégration musique sur page d\'accueil',
        objectifs5: '',
        objectifs6: '',        
        technologies: 'Technologies utilisées :',
